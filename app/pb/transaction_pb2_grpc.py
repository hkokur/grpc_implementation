...
import pb.transaction_pb2 as transaction__pb2
...
class TransactionStub(object):
    ...
    def __init__(self, channel):
        ...
        self.MakeTransaction = channel.unary_unary(
                ...
                request_serializer=transaction__pb2.TransactionMessage.SerializeToString,
...
def add_TransactionServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'MakeTransaction': grpc.unary_unary_rpc_method_handler(
                    ...
                    request_deserializer=transaction__pb2.TransactionMessage.FromString,
...
class Transaction(object):
    ...
    def MakeTransaction(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/transaction.Transaction/MakeTransaction',
            transaction__pb2.TransactionMessage.SerializeToString,
